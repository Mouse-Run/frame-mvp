...
public class TableViewAdapter extends RecyclerView.Adapter<TableViewAdapter.TableViewHolder> {
     ...
     * Item checkBox点击事件
     */
    private LockTableView.OnItemCheckBoxListener mOnItemCheckBoxListener;
        ...
        if (isLockColumn) {
            ...
            if (mLockAdapter == null) {
                ...
                if (mOnItemCheckBoxListener != null) {
                    mLockAdapter.setOnItemCheckBoxListenter(mOnItemCheckBoxListener);
                }
    ...
    public void setOnItemCheckBoxClickListener(LockTableView.OnItemCheckBoxListener mOnItemCheckBoxListener) {
