package com.mouse.modulewidget.pgexcel.locktableview;
...
public class LockColumnAdapter extends RecyclerView.Adapter<LockColumnAdapter.LockViewHolder> {
    ...
    /**
     * Item项Checkbox(处理Checkbox选中事件)
     */
    private LockTableView.OnItemCheckBoxListener mOnItemCheckBoxListenter;
    ...
    public void onBindViewHolder(LockViewHolder holder, final int position) {
        ...
        holder.mCheckBox.setLayoutParams(layoutParams);
        //设置颜色
        if (!isLockFristRow) {
            if (position == 0) {
        ...
        if (mOnItemCheckBoxListenter != null) {
            holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        mOnItemCheckBoxListenter.onItemCheckBoxClick(position, true);
                    } else {
                        mOnItemCheckBoxListenter.onItemCheckBoxClick(position, false);
                    }
                }
            });
        }
    ...
    public void setOnItemCheckBoxListenter(LockTableView.OnItemCheckBoxListener mOnItemCheckBoxListenter) {
        this.mOnItemCheckBoxListenter = mOnItemCheckBoxListenter;
    }
}
