...
import com.mouse.modulewidget.pgexcel.xrecyclerview.ProgressStyle;
import com.mouse.modulewidget.pgexcel.xrecyclerview.XRecyclerView;
...
//            Log.e("每行数据", mTableRowDatas.toString());
    ...
    private void initView() {
        ...
        if(mOnItemCheckBoxListener!=null){
            mTableViewAdapter.setOnItemCheckBoxClickListener(mOnItemCheckBoxListener);
        }
        if (mOnItemSeletor != 0) {
    ...
    public LockTableView setOnItemCheckBoxStatusListenter(OnItemCheckBoxListener mOnItemCheckBoxListener){
    ...
    /**
     * 说明 Item中Checkbox点击返回状态
     * 作者 Mouse
     * 创建时间 2021/5/12 上午11:04
     */
    public interface OnItemCheckBoxListener{
        void onItemCheckBoxClick(int position, boolean checkBoxStatus);
    }
}
