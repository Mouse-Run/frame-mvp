package com.mouse.modulemvp.log;
...
public class XLog {
    ...
    public static boolean LOG = com.mouse.modulemvp.XDroidConf.LOG;
    public static String TAG_ROOT = com.mouse.modulemvp.XDroidConf.LOG_TAG;
